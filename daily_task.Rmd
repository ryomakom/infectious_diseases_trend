...
if (length(data_list) > 0) {
  ...
  cleaned_diseases %>%
    filter(pref == "Nationwide")  %>% write_excel_csv("docs/results/data-全国.csv")
  cleaned_diseases %>%
    filter(pref == "Tokyo") %>% write_excel_csv("docs/results/data-東京都.csv")
  cleaned_diseases %>%
    filter(!pref %in% c("Nationwide","Tokyo")) %>%
